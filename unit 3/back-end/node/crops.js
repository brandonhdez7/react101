...
// some takes 1 arg:
// a callback, This callback will run on every element 
// on the Array 
// if the calback returns true on any 
// element then some returns true
...
// every takes one argument: a callback 
// that calls will run on every Element, in the Array
// if all return true, then every return true
// if any return false, then every return false
...
// filter is exactly the same like map 
// except map pushes something on foe every element 
